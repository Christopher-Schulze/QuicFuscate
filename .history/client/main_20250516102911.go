...
func main() {
	...
	// QUIC-Verbindung herstellen
	session, err := quic.DialAddr(config.ServerAddr, nil, nil)
	if err != nil {
...
func SendKeepalive(session quic.Session) error {
	// Keepalive-Logik aus keepalive.go wiederverwenden
	return nil
}
