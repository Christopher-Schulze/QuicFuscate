...
**Closure rule:** Production-ready means all TODO-508 through TODO-516 are done, local and GitHub gates are green, and every remaining exception is either intentionally deferred with a documented operator impact or removed from product-facing claims.
