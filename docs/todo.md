...
| TODO-522 | S | P0 | Close kill-switch automatic-loss handling and privileged runtime proof | **OPEN** - active: automatic engine/standalone loss ownership is implemented; exact ARM64 Omega nftables proof passes selected VPN DNS, zero direct DNS/IPv6 leaks, a 15,005 ms fail-closed transition for a 15,000 ms timeout, retained state, stale cleanup, and SIGTERM cleanup. Final exact-commit refresh remains. | TODO-429, TODO-521 |
