...
| TODO-519 | I | P2 | Windows desktop build: cfg-gate Unix-specific core library code | **OPEN** - Native MSVC check, serial 1,671-test execution, and Clippy pass. The restored parallel gate exposed a process-wide test override race; the thread-local correction passes complete parallel ARM64 and Rosetta x86_64 suites plus Windows GNU check/test-link/Clippy. Native parallel MSVC execution, Tauri MSI packaging/upload, and signed updater-manifest proof remain open. | - |
