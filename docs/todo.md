...
**Latest checkpoint (TODO-504)**: FEC interleaved recovery isolation is DONE. `InterleavedDecoder::get_result()` now only runs full recovery on blocks that actually need it and drains partial work only from recovery-active blocks. Broderick `fec_decode_pipeline/streaming/batch128_no_loss_reuse` improved from about `220.83 us` to `180.48 us`, and `batch128_10pct_reuse` improved from about `499.58 us` to `256.97 us`.
...
Detail files: `docs/todo/todo-{464,465,466,467,468,469,470,471,472,473,474,475,476,477,478,479,480,481,482,483,484,485,486,487,488,489,490,491,492,493,494,495,496,497,498,499,500,501,502,503,504}-*.md`.
