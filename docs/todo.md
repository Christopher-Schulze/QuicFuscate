...
| TODO-515 | S | P0 | Wire AuditLogger into server runtime | **OPEN** - audit module (`src/audit/mod.rs`) is defined but not wired into the server runtime; no auth/QKey/admin/firewall/connection/config/system events are emitted; integrate at the TODO-439 Phase 6 integration points | TODO-439, TODO-511 |
