...
| TODO-522 | S | P0 | Close kill-switch automatic-loss handling and privileged runtime proof | **OPEN** - active: canonical engine/standalone loss ownership and fail-closed firewall lifecycle are under implementation; initial source proof also found IPv6, nftables loopback, and cleanup defects. | TODO-429, TODO-521 |
