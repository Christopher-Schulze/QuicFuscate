...
| TODO-520 | S | P0 | Remove observable QKey bearer from QUIC Initial packets | **OPEN** - RFC 9000/9001 and source-flow audit prove the client QKey bearer is injected into client transport parameters carried by the observable ClientHello. Remove that channel and retain authentication exclusively after handshake encryption without weakening the existing pre-auth data gate. | TODO-415 |

Detail files: `docs/todo/todo-{508,509,510,511,512,513,514,515,516,517,518,519,520}-*.md`.

**Closure rule:** The v0.4.0 readiness wave required TODO-508 through TODO-518 and TODO-412 to be DONE through local or Broderick evidence. TODO-519 is also DONE through native MSVC, signed Windows MSI, updater-manifest, Linux, and macOS release evidence. Current end-to-end production readiness requires TODO-520 removal of the observable pre-handshake QKey bearer. Documentation claims alone are not completion evidence.
