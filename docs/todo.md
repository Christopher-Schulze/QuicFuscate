...
**Current State (2026-07-25):** The protocol optimization, FEC performance, stealth coherence, TUN data-plane, CI/release, and completed production-evidence waves retain their individual proof. The exhaustive legacy-acceptance reconciliation is complete; 26 genuine remaining gaps are represented directly by open TASKs in the ordered production register below. TODO-532 (multipath) was scrapped by owner decision; TODO-562 (workspace crate refactoring) was added to the register.
...
**Handoff coverage:** The ordered register contains 26 open product TASKs and `docs/todo/` contains exactly 26 corresponding `status: OPEN` detail files. Every open detail owns its motivation, acceptance contract, completion gates, executable sub-tasks, dependency boundary, current findings, and deviations. No separate readiness or closure umbrella exists. A successor must read this register and the selected detail file rather than treating either one alone as sufficient acceptance.

**Current execution:** Execute TODO-544 -> TODO-559 -> TODO-560 -> TODO-557 and continue the ordered register. TODO-556 is closed on exact commit `06e60435604678bc0f7c47c633d557496654a4d8` with Node.js 24-backed first-party actions, zero annotations across 29 check runs, green CI `30156460437`, Clippy Matrix `30156460410`, Release Build `30156460404`, and verified native artifacts. TODO-561 performs the final canonical-document reconciliation after all non-Dioxus contracts stabilize and before the frozen Dioxus parity reference is created. During Dioxus work, the existing Svelte web-admin and Svelte/Tauri desktop UI are read-only references and must remain byte- and pixel-identical.
...
## Active - Production Readiness Execution Register (2026-07-23)
...
|---:|---|---|---|---|---|
| 1 | TODO-544 | Transport | Complete RFC loss detection and network proof | **OPEN** - canonical sent-packet ownership, deadlines, PTO/loss correctness, CC propagation, and netem proof remain. | TODO-463 |
| 2 | TODO-559 | Data plane | Make TUN/MASQUE sustained throughput backpressure-safe | **OPEN** - transient DATAGRAM pressure is erased into InternalError and consumed TUN frames can be lost before carrier acceptance. | TODO-422, TODO-534, TODO-544, TODO-555 |
| 3 | TODO-560 | FEC | Make active-connection FEC policy changes truthful | **OPEN** - Engine runtime setters and server reload update configuration or stats without a proven active-connection policy transition. | TODO-558, TODO-559 |
| 4 | TODO-557 | Evidence | Make specialized FEC E2E acceptance executable and truthful | **OPEN** - parked behind truthful Off/telemetry and sustained delivery; header claims and executable assertions still diverge. | TODO-423, TODO-425, TODO-427, TODO-524, TODO-547, TODO-555, TODO-558, TODO-559 |
| 5 | TODO-526 | Secrets | Close retained secret erasure boundaries | **OPEN** - AEGIS derived state and raw QKey allocations still need zeroizing ownership and failable erasure proof. | TODO-440, TODO-516 |
| 6 | TODO-539 | Secrets | Make QKey registry encryption fail closed | **OPEN** - key ownership, envelope, migration, rotation, corruption, and failure atomicity remain. | TODO-458, TODO-526 |
| 7 | TODO-529 | Policy | Wire per-client bandwidth, quota, and fairness enforcement | **OPEN** - helper state is not owned by live sessions or forwarding. | TODO-445, TODO-523 |
| 8 | TODO-538 | Policy | Complete QKey auth backoff and block lifecycle | **OPEN** - configurable exponential backoff, typed blocks, pruning, metrics, and flood proof remain. | TODO-456 |
| 9 | TODO-540 | Policy | Complete sustained DDoS policy and live proof | **OPEN** - interval-correct sampling, Retry enforcement, cache durability, and false-positive proof remain. | TODO-459, TODO-529, TODO-538 |
| 10 | TODO-527 | Runtime | Complete irreversible privilege reduction and post-drop proof | **OPEN** - groups, no-new-privileges, capability clearing, diagnostics, and root-start traffic proof remain. | TODO-441, TODO-515 |
| 11 | TODO-531 | Runtime | Wire production logging configuration and lifecycle proof | **OPEN** - operator configuration, bounded failure behavior, flush, and performance proof remain. | TODO-446, TODO-527 |
| 12 | TODO-525 | Runtime | Complete audit durability, taxonomy, and throughput contract | **OPEN** - bounded asynchronous persistence, rotation, checkpoints, taxonomy, and saturation proof remain. | TODO-439, TODO-515, TODO-527, TODO-531 |
| 13 | TODO-530 | Firewall | Wire firewall backend override and privileged nftables proof | **OPEN** - one backend owner, explicit failure, fallback, atomicity, and unified table proof remain. | TODO-444, TODO-522, TODO-523, TODO-527 |
| 14 | TODO-542 | Firewall | Complete owned TUN and firewall cleanup lifecycle | **OPEN** - typed ownership, postconditions, client symmetry, injected failures, and crash cleanup remain. | TODO-461, TODO-530 |
| 15 | TODO-541 | Deployment | Prove Linux installer across clean distro lifecycles | **OPEN** - clean Debian/RHEL, rerun, prerequisite failure, and final runtime contract proof remain. | TODO-460, TODO-527, TODO-530, TODO-531, TODO-542 |
| 16 | TODO-548 | Platform | Install and prove the managed macOS PF kill-switch anchor | **OPEN** - reversible anchor ownership and privileged coexistence/packet proof remain. | TODO-522, TODO-530, TODO-542 |
| 17 | TODO-528 | Platform | Prove Wintun native adapter and data-plane lifecycle | **OPEN** - real adapter, WFP, packet transfer, close/read safety, and privileged native proof remain. | TODO-442, TODO-519, TODO-530, TODO-542 |
...
| 19 | TODO-537 | Transport | Complete timer-owned traffic-analysis defense proof | **OPEN** - lifecycle timer/slot scheduling, bounded cadence, authenticated policy, warning, and capture proof remain. | TODO-455, TODO-544 |
| 20 | TODO-543 | Transport | Complete TCP and ICMP fingerprint runtime proof | **OPEN** - full egress wiring, profile coupling, PMTUD-safe behavior, tool, allocation, and throughput proof remain. | TODO-462, TODO-534, TODO-544 |
| 21 | TODO-561 | Documentation | Reconcile canonical documentation and evidence-state truth | **OPEN** - canonical docs still contain completed-task, release-checkpoint, and platform-proof claims that contradict the current register and retained evidence. | TODO-525, TODO-526, TODO-527, TODO-528, TODO-529, TODO-530, TODO-531, TODO-533, TODO-537, TODO-538, TODO-539, TODO-540, TODO-541, TODO-542, TODO-543, TODO-544, TODO-548, TODO-556, TODO-557, TODO-558, TODO-559, TODO-560 |
| 22 | TODO-562 | Architecture | Refactor single-crate monolith into Cargo workspace sub-crates | **OPEN** - 136k LoC single crate; no incremental compilation, no enforced module boundaries, global feature flags. | TODO-561 |
| 23 | TODO-549 | Dioxus | Lock the parity reference and build the shared Dioxus component system | **OPEN** - no active Dioxus parity surface exists. | TODO-529, TODO-531, TODO-538, TODO-539, TODO-540, TODO-561 |
| 24 | TODO-550 | Dioxus | Rebuild the web admin in Dioxus with exact parity | **OPEN** - Dioxus web-admin implementation and proof do not exist. | TODO-525, TODO-529, TODO-531, TODO-538, TODO-539, TODO-540, TODO-549, TODO-560 |
| 25 | TODO-551 | Dioxus | Rebuild the desktop client in Dioxus with exact parity | **OPEN** - direct Rust desktop integration and parity proof do not exist. | TODO-527, TODO-528, TODO-530, TODO-533, TODO-537, TODO-541, TODO-542, TODO-543, TODO-544, TODO-545, TODO-548, TODO-549, TODO-560 |
| 26 | TODO-552 | Dioxus | Certify and package Dioxus web and desktop parity | **OPEN** - cross-surface fidelity, accessibility, performance, packaging, and release evidence do not exist. | TODO-550, TODO-551 |
...
| TODO-556 | GitHub Actions Node.js 24 runtime migration | **DONE** - 29 exact-commit check runs are annotation-free; CI, Clippy Matrix, and Release Build are green with verified native artifacts. |
...
| TODO-514 | Stealth traffic realism validation | **DONE** - mode policy and 75 tests passed. |
| TODO-515 | AuditLogger runtime wiring | **DONE** - runtime emitters, production verifier, and live chain proof passed. |
| TODO-516 | Process and pool memory locking | **DONE** - exact production boundary and native ARM64 `VmLck` proof passed. |
| TODO-517 | Typed Brain hint channels | **DONE** - raw hint atomics encapsulated without hot-path regression. |
| TODO-518 | Global atomic-state reconciliation | **DONE** - documentation and code counts aligned. |
| TODO-519 | Native Windows desktop/core release boundary | **DONE** - MSVC tests, Clippy, signed MSI, and updater manifest passed. |
| TODO-520 | Canonical encrypted QKey bearer contract | **DONE** - dead transport-parameter path removed and native/live gates passed. |
| TODO-522 | Kill-switch automatic-loss runtime proof | **DONE** - local/native/CI/release and isolated Omega leak/loss matrix passed. |
| TODO-523 | Multi-client dual-stack TUN and ICMP | **DONE** - three-client isolation, fan-out, PTB, throughput, and cleanup passed. |
| TODO-524 | Interleaved FEC recovery proof | **DONE** - exact mapping and 1,000-packet random/burst matrices passed. |
| TODO-534 | DPLPMTUD and TUN coupling | **DONE** - 1280 black-hole recovery, 1500 re-confirmation, and 38.85% gain passed. |
| TODO-535 | CUBIC conformance and performance | **DONE** - RFC behavior, fairness `0.999974`, and 95.38% loss retention passed. |
| TODO-536 | QUIC v2 and version negotiation | **DONE** - v1/v2/fallback local, native, release, and Omega gates passed. |
| TODO-546 | Windows SIMD native core gate | **DONE** - adversarial parity and native Windows CI passed. |
| TODO-547 | FEC wire framing and live 1-RTT integrity | **DONE** - versioned MTU-bounded wire and ARM64 loss matrices passed. |
| TODO-362 | FEC internal dead-code audit | **DONE** - every suppression was classified, dead constructors were removed, test-only ownership was narrowed, and exact native/artifact gates passed. |
| TODO-545 | Cipher reinstallation state safety | **DONE** - fresh typed key material, counter preservation, retirement, exhaustion, adversarial, native security, artifact, and Omega gates passed. |
| TODO-553 | Relocatable ARM64 release checksum | **DONE** - basename-only adjacent sidecars verify directly in clean local and Omega extraction directories. |
| TODO-554 | Owned base TUN E2E cleanup | **DONE** - exact child ownership, unrelated-process survival, two clean Omega runs, native CI, release artifacts, and zero-residue teardown passed. |
| TODO-555 | Owned specialized TUN E2E cleanup | **DONE** - four FEC/loss harnesses own exact resources; exact native artifact matrices and zero-residue teardown passed. |
| TODO-558 | FEC-off control and live observability | **DONE** - lifetime Off, typed transport feedback, bounded Fountain rescue, repeated Omega Off/Auto matrices, native CI/Clippy/Release, artifact integrity, and zero-residue teardown passed. |

Active detail files live at `docs/todo/todo-NNN-*.md`; completed detail files move to `docs/todo/done/todo-NNN-*.md`.

**Closure rule:** Documentation claims never close production readiness. The repository reaches production readiness only when the ordered active queue is empty and its zero-open state is backed by passing task consistency, runtime guardrails, full local gates, required native platform gates, release artifacts, isolated live evidence, and clean teardown.
...
- TODO-358: Dead PQ traits - the source cleanup is complete.
