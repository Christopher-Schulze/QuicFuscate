...
| TODO-547 | S | P0 | Restore FEC wire framing and live 1-RTT integrity | **OPEN** - the versioned, MTU-bounded, epoch-driven codec cascade is implemented locally with deterministic repair metadata, optimized GF4/GF8/GF16 selection, and Fountain reserved for rescue. Full native and Omega runtime proof remains required. | TODO-422, TODO-473, TODO-524, TODO-521 |
