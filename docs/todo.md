...
**Current State (2026-07-25):** The protocol optimization, FEC performance, stealth coherence, TUN data-plane, CI/release, and completed production-evidence waves retain their individual proof. The exhaustive legacy-acceptance and Dioxus-goal reconciliation is complete; 31 genuine remaining gaps are represented directly by open TASKs in the ordered production register below. TODO-532 (multipath) was scrapped by owner decision. TODO-563 through TODO-567 now own the explicitly requested post-parity VisionOS Liquid Glass redesign, final certification, and production cutover.
...
**Handoff coverage:** The ordered register contains 31 open product TASKs and `docs/todo/` contains exactly 31 corresponding `status: OPEN` detail files. Every open detail owns its motivation, acceptance contract, completion gates, executable sub-tasks, dependency boundary, current findings, and deviations. No separate readiness or closure umbrella exists. A successor must read this register and the selected detail file rather than treating either one alone as sufficient acceptance.

**Current execution:** Finish the already-started TODO-544 source and standards audit, then start TODO-549 immediately. Continue the backend and platform dependencies in queue order, implement Dioxus parity through TODO-550 and TODO-551, reconcile canonical truth in TODO-561, certify parity in TODO-552, execute the post-parity VisionOS program in TODO-563 through TODO-566, and perform the production cutover in TODO-567. TODO-556 is closed on exact commit `06e60435604678bc0f7c47c633d557496654a4d8` with Node.js 24-backed first-party actions, zero annotations across 29 check runs, green CI `30156460437`, Clippy Matrix `30156460410`, Release Build `30156460404`, and verified native artifacts. During all Dioxus work, the existing Svelte web-admin and Svelte/Tauri desktop UI are read-only references and rollback surfaces and must remain byte- and pixel-identical.
...
- Do not introduce Docker, container images, Compose files, container-based test paths, or Docker-owned CI and deployment workflows. Use direct native builds, isolated process directories, and host-native service tooling.
...
**Execution strategy:** finish the active loss-detection boundary -> lock the immutable Dioxus parity reference and shared foundation -> close backend, native, and evidence dependencies -> implement exact Dioxus web and desktop parity -> reconcile canonical truth -> certify parity -> create and implement the VisionOS Liquid Glass system -> refactor Rust crate boundaries without touching protected legacy UI -> certify the redesigned product -> cut over native Dioxus release paths.
...
| 2 | TODO-549 | Dioxus | Lock the parity reference and build the shared Dioxus component system | **OPEN** - no active Dioxus parity surface exists. | TODO-544 |
...
| 19 | TODO-533 | Transport | Complete configurable migration and CC path adaptation | **OPEN** - typed path-change policy, validation RTT, CC-specific state, and active-transfer proof remain. | TODO-450, TODO-544 |
| 20 | TODO-537 | Transport | Complete timer-owned traffic-analysis defense proof | **OPEN** - lifecycle timer/slot scheduling, bounded cadence, authenticated policy, warning, and capture proof remain. | TODO-455, TODO-544 |
...
| 22 | TODO-550 | Dioxus | Rebuild the web admin in Dioxus with exact parity | **OPEN** - Dioxus web-admin implementation and proof do not exist. | TODO-525, TODO-529, TODO-531, TODO-538, TODO-539, TODO-540, TODO-549, TODO-560 |
| 23 | TODO-551 | Dioxus | Rebuild the desktop client in Dioxus with exact parity | **OPEN** - direct Rust desktop integration and parity proof do not exist. | TODO-527, TODO-528, TODO-530, TODO-533, TODO-537, TODO-541, TODO-542, TODO-543, TODO-544, TODO-545, TODO-548, TODO-549, TODO-560 |
| 24 | TODO-561 | Documentation | Reconcile canonical documentation and evidence-state truth | **OPEN** - canonical docs still contain completed-task, release-checkpoint, and platform-proof claims that contradict the current register and retained evidence. | TODO-525, TODO-526, TODO-527, TODO-528, TODO-529, TODO-530, TODO-531, TODO-533, TODO-537, TODO-538, TODO-539, TODO-540, TODO-541, TODO-542, TODO-543, TODO-544, TODO-548, TODO-556, TODO-557, TODO-558, TODO-559, TODO-560 |
| 25 | TODO-552 | Dioxus | Certify and package Dioxus web and desktop parity | **OPEN** - cross-surface fidelity, accessibility, performance, packaging, and release evidence do not exist. | TODO-550, TODO-551, TODO-561 |
| 26 | TODO-563 | Design | Lock the post-parity VisionOS Liquid Glass system | **OPEN** - the requested premium post-parity product direction has no accepted concept, token system, or implementation contract. | TODO-552 |
| 27 | TODO-564 | Dioxus | Redesign the Dioxus web admin in VisionOS Liquid Glass | **OPEN** - the certified parity implementation has not been transformed into the requested premium web experience. | TODO-563 |
| 28 | TODO-565 | Dioxus | Redesign the Dioxus desktop client in VisionOS Liquid Glass | **OPEN** - the certified parity implementation has not been transformed into the requested premium native desktop experience. | TODO-563 |
| 29 | TODO-562 | Architecture | Refactor single-crate monolith into Cargo workspace sub-crates | **OPEN** - 136k LoC single crate; no incremental compilation, no enforced module boundaries, global feature flags. | TODO-561 |
| 30 | TODO-566 | Evidence | Certify the redesigned Dioxus product end to end | **OPEN** - the redesigned web and desktop surfaces lack cross-platform quality, performance, accessibility, and release proof. | TODO-562, TODO-564, TODO-565 |
| 31 | TODO-567 | Release | Cut over production release paths to Dioxus | **OPEN** - Dioxus candidates are not the default web and desktop release artifacts and no production cutover proof exists. | TODO-566 |
