...
| TODO-482 | R | P2 | FEC lazy clean sequence tracker | **DONE** - `LazyDecoder` replaced per-source `BTreeSet` tracking with a heap-free contiguous clean-path tracker plus sparse interval fallback, preserving duplicate, gap, and gap-fill semantics while eliminating clean-path tree-node allocation | TODO-424, TODO-476, TODO-481 |

Detail files: `docs/todo/todo-{464,465,466,467,468,469,470,471,472,473,474,475,476,477,478,479,480,481,482}-*.md`.
