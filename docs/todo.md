...
| TODO-494 | R | P1 | Transport default adaptive padding direct branch | **DONE** - Product-default 64-byte adaptive padding now uses a direct branch with `cur_pt_len & 63` and `64 - rem`, preserving custom granularity behavior while cutting Broderick `adaptive_100pct` from about `5.49 ns` to about `5.27 ns` | TODO-492 |
...
Detail files: `docs/todo/todo-{464,465,466,467,468,469,470,471,472,473,474,475,476,477,478,479,480,481,482,483,484,485,486,487,488,489,490,491,492,493,494,495}-*.md`.
