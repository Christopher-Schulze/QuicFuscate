...
| TODO-516 | S | P1 | Implement mlock/mlockall for key material and memory pools | **OPEN** - zeroize is complete for all AEADs and PKI, but mlock/mlockall is not implemented; add mlockall on server startup, mlock MemoryPool blocks, lock_memory/lock_blocks config fields | TODO-440, TODO-511 |
