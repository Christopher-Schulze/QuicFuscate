...
- Exact ARM64 source `24c4a92` ran that three-child contract against unchanged binary `c54d2d5e1c600790fcc0c2d437fdb5f3942e8337dadd2138896f0bf958ac6a2e` and failed closed: child statuses were failed/passed/failed. Child 2 completed receiver-valid default/opt-in medians of 7.433/10.635 Mbit/s, 43.09% gain, 2-second detection, and a 15,335,424-byte recovery transfer in 20.688 seconds. Children 1 and 3 completed their default medians at 7.437 and 8.362 Mbit/s but failed in opt-in before a receiver artifact after client-1 persistent congestion at 0.07% and 0.06% observed loss; child 3 then hit the fail-closed heartbeat watchdog on clients 2 and 3. Every child used the identical binary and external capture, and teardown left no product process, namespace, qf523 link, or qdisc. This is a reproducible production blocker, not a scheduler correction candidate.
