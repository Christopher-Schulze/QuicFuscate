...
- Latest uniform-loss harness proof: source commit `a8c41aa8e8e7373de2c4c58b14fba7c675544599` ran on Omega against the ARM64 binary SHA-256 `322060acffd79abe30ed7d8e4238933b0106c2df1ab3e116793e62073da8d32b`. It passed all six single-source cases: 0/5/10/25% ping loss of 0/1/2/27% and JSON-verified receiver throughput of 1.047304/1.047557 Mbit/s at 0/10% netem loss. The run left no owned process, namespace, or veth, and the remote source tree was clean.
...
- Native burst evidence now uses the explicit three-trial contract: harness-source `a8c41aa8e8e7373de2c4c58b14fba7c675544599` passed on Omega against ARM64 binary SHA-256 `322060acffd79abe30ed7d8e4238933b0106c2df1ab3e116793e62073da8d32b`. Mild samples were 2/1/0% (median 1%, maximum 2%); heavy samples were 3/1/3% (median 3%, maximum 3%). Cleanup left no owned process, namespace, or veth, and the remote source tree was clean.
...
- Latest exact-artifact liveness proof: harness-source `04eea5cb9` passed all 25 Omega cases against ARM64 binary SHA-256 `322060acffd79abe30ed7d8e4238933b0106c2df1ab3e116793e62073da8d32b`. The recovery path was clean/loss/recovered 0/18/0%; the run left no owned namespaces or source-tree residue. This is liveness evidence only, not a throughput, overhead, mode-stability, or comparative-FEC claim.
