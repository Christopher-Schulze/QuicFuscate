...
- Local Windows-GNU compilation and product Clippy prove the complete feature-gated Rust surface. Native CI run `30504148233`, attempt 2, job `90752348969` proves the pushed MSVC check, 1,929 ordinary tests, privileged adapter/data-plane/close lifecycle, zero adapter residue, and strict Clippy. Authenticated QuicFuscate traffic, the successor native WFP policy run, and exact signed MSI artifact evidence remain open under TODO-528.
