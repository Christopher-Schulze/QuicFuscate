...
- **Open evidence:** Hosted CI, full Playwright Chromium E2E under TODO-756, Linux/Windows native packaging, updater signing, and tagged publication remain external gates. Existing non-failing static-adapter, Vite, Svelte test-warning, and Rust dead-code diagnostics remain documented; none was suppressed. No frontend visual/UI source, remote checkout, or Omega state changed.
