...
- Precommit seam evidence is `scripts/out/audits/workspace-seams-20260810T-frames-varint-precommit/workspace-seams.json`: source revision `867aaf0f0266982ae8f161b51f483eefec9d87d9`, `36` workspace packages, `326` Rust files, `206,514` source lines, `125` module edges, `110` Cargo workspace dependency edges, the unchanged 9-module product SCC (`brain`, `core`, `engine`, `fec`, `implementations`, `interface`, `qftls`, `stealth`, `transport`), and `protected_changes=[]`.
