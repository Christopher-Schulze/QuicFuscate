...
- `tun-e2e-fec-burst-netns.sh` - Linux netns correlated burst-loss ping/liveness proof. TODO-558 supplies the truthful Off control; comparative FEC recovery benefit remains pending the TODO-557 acceptance contract.
