...
- Latest complete transition proof: harness-source `d714df3659107e1450bb85cdb5ca2c70275ca896` ran all selected `TRANSITION_SCENARIOS` on Omega against binary SHA-256 `322060acffd79abe30ed7d8e4238933b0106c2df1ab3e116793e62073da8d32b`. Auto/moderate was 0/12/0% within 5/35/10%; Off/moderate was 0/18/0%, proving immutable Zero policy; Auto/severe was 0/42/0% within 5/60/10%. Every run printed its selected source row, passed the telemetry policy contract, and left no owned process, namespace, veth, or source-tree residue.
