...
- **Server fan-out and MTU:** The shared broadcast/multicast queue finding is resolved by TODO-612; its bounded admission, drop telemetry, and housekeeping work budget are reconciled below. The IPv4 uplink path returns oversized non-DF packets without userspace fragmentation or an explicit disposition; native backend behavior remains unproven. Tracked in TODO-613.
