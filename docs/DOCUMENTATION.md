...
- **Graph evidence:** The post-reconciliation refresh at `scripts/out/audits/graphify-20260807T012617Z/graphify-evidence.json` is explicitly `BLOCKED` for unavailable semantic extraction, incomplete/unsupported coverage, and raw/normalized/legacy relationship limitations. It is not promoted to a green audit result.
