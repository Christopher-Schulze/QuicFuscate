...
- **Open remediation:** TODO-634 retains Fountain storage/queue growth, TODO-636 peeling complexity, TODO-637 Wiedemann scratch reuse, TODO-690 solver correctness, and TODO-715 retains GF16 PCLMUL mathematics. TODO-859 retains complete per-backend negative/differential proof and documentation truth. TODO-860 retains direct zero/Fountain counter wrap, non-divisible interleave flooring, 32-bit sequence narrowing, repair-ID shift aliasing, Fountain wire source-ID underflow, and remaining unchecked decoder/Wiedemann/Fountain arithmetic. Shared transport and environment owners remain in force.
