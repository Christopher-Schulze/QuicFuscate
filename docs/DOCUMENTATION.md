...
- Exact ARM64 evidence for commit `c609c68` proves the real authenticated TUN/MASQUE carrier under both sustained UDP/FEC and dual-stack TCP pressure: the CUBIC Auto-FEC matrix retained 99.56% at controlled 5% loss, while the three-client DPLPMTUD harness measured a 15.32% 1280-to-1500 gain and completed the 20-second 1280-byte black-hole fallback/re-probe transfer. The durable matched control harness at source `3b20cd1` then recorded Auto 2.982 Mbit/s and 99.38% retention versus FEC-off 2.830 Mbit/s and 94.32% under the same three-clean/three-loss trial contract, a measured delta of 0.152 Mbit/s and 5.06 percentage points. The specialized quantitative FEC-contract work remains separately tracked by TODO-557.
...
Harness-source commit `3b20cd1d4343257d49e766c8fe81152d069093fd` makes the control durable: it creates its leaf certificate only inside the explicit artifact directory, executes three clean and three 5%-loss trials for each of Auto and FEC-off, and emits per-policy JSON plus a combined comparison. Against ARM64 binary SHA-256 `322060acffd79abe30ed7d8e4238933b0106c2df1ab3e116793e62073da8d32b`, Auto recorded 3.001/2.982 Mbit/s and 99.38% retention; FEC-off recorded 3.001/2.830 Mbit/s and 94.32% retention; the observed Auto-minus-Off difference was 0.152 Mbit/s and 5.06 percentage points. The same run measured CUBIC/Reno at 1.064/1.061 Mbit/s with Jain `0.999998`, retained its artifact at `/tmp/qf-3b20cd1-cubic.t2sP2k`, and left no product process, namespace, bridge, or qdisc behind.
