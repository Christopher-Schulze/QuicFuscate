...
- Latest moderate Auto transition proof: harness-source `39dd360db590499e8c1603928a99bffd79914874` ran on Omega against binary SHA-256 `322060acffd79abe30ed7d8e4238933b0106c2df1ab3e116793e62073da8d32b`. The clean/impaired/recovered loss values were 0/21/0%, within the 5/35/10% contract; telemetry policy checks passed with one endpoint handshake each and zero panic or decrypt failures.
- The remaining targeted transition matrix also passed against that artifact: Off/moderate produced 0/20/0%, proving immutable Zero policy under loss; Auto/severe produced 0/42/0%, within the 5/60/10% bounds. Both retained isolated manifests and left no owned runtime residue.
- `tun-e2e-fec-netem-adversity.sh` - Linux netns ping/liveness matrix for loss, jitter, bandwidth, RTT+loss, mobile-network mix, and recovery. Quantitative throughput, overhead, mode-stability, carrier backpressure, and recovery-latency acceptance is pending TODO-559 and TODO-557.
