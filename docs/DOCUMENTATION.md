...
- **Interface/platform unsafe**: TODO-683 completed the read-only audit of
  ...
  lifecycle and concurrency proof (TODO-846), WFP engine/transaction ownership
  (TODO-847), and remaining negative/native proof (TODO-848) remain open. No
  privileged native execution is claimed for TODO-845.
