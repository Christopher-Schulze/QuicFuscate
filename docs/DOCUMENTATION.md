...
- **Resource boundary:** The configured nominal retained-segment budget is at most 8 GiB. This is a rotation/retention threshold budget, not a hard per-file payload cap; TODO-814 owns event-size limits and TODO-727 owns bounded reads of already-existing files.
