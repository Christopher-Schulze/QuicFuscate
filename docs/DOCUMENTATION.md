...
- All TODO-508 through TODO-520, TODO-412, and the reopened TODO-448 graceful-drain contract are DONE. Current source checkpoint `bef00fe6501baa1d5fc99ad25f5e8e89c9b6d4a3` passes local full Rust gates, GitHub CI `29880712890`, Clippy Matrix `29880712914`, native ARM64 release job `88800780673`, and the exact two-client lifecycle proof on Omega in 5118 ms.
