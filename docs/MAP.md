...
- Remote proof runbook: `docs/remote-proof-runbook.md` retains the exact commands, expected outputs, and close criteria for the native Broderick soak and signed release lifecycle proofs.
