...
- Fresh seam evidence at `scripts/out/audits/workspace-seams-20260808T211434Z/workspace-seams.json` records seven packages (root plus six leaves), 240 Rust files, 203,481 source lines, root edges to all six leaves, one `qf-pki -> qf-common` edge, the unchanged 16-module SCC, and no protected changes.
