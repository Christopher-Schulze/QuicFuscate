...
- **Boundary:** Chromium E2E, hosted CI, Linux/Windows native packaging, updater signing, and tagged publication remain open owners or external gates. No frontend visual/UI source, remote checkout, or Omega state changed.
