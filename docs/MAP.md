...
- **Targeted proof:** Admission tests passed 2/2, the drop metric test passed 1/1, DNS module tests passed 22/22, and the complete server module passed 131/131. `cargo fmt --all -- --check` and `git diff --check` passed.
