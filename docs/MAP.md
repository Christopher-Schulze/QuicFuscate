...
- Detection accounts for code, documents, images, sensitive files, and Git ignored/generated/dependency classes. The current run covers 724 detected files, including 332 Rust files and 138 scripts; six detected files without AST nodes remain an explicit unsupported-surface entry.
