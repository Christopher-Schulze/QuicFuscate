...
- **Unsafe QKey/admin**: TODO-685's current-source reconciliation found no raw-memory unsafe operation in QKey registry or admin session logic. QKey registry storage retains one Windows `MoveFileExW` path-encoding and native-proof boundary under TODO-873; TODO-861 owns audit-file FFI, TODO-728 owns audit pathname binding, and TODO-647/TODO-661/TODO-665 own admin session lifecycle and replay contracts.
