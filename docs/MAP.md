...
- `scripts/tests/tun-e2e-fec-burst-netns.sh`: exact-artifact 1,000-packet correlated burst-loss gates; one heavy-burst trial reached 12% and failed its current 10% single-run limit, while three repetitions passed. Statistical qualification and comparative benefit remain under TODO-557.
