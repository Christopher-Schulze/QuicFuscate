...
- `scripts/tests/tun-e2e-fec-netns.sh`: exact-artifact 1,000-packet 0/5/10/25% ping gates and bounded JSON-verified iperf receiver sub-runs at 0% and 10% loss; quantitative FEC benefit and telemetry remain under TODO-557.
