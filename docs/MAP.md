...
- **Transport/Stealth**: terminal close priority (TODO-697; first-close-wins idempotency resolved by TODO-606; local close error-kind semantics resolved by TODO-772), ConnectionId clone hot path (TODO-638), StealthShaper seed lifecycle (TODO-639, complete), H3 masquerade time source (TODO-640, complete), domain fronting selection (TODO-641, complete), TLS cover zero-key fallback (TODO-642), and brain escalation/histogram/config correctness (TODO-584). TODO-639 closure evidence is stealth-focused 266/266, CC/Recovery integration 20/20 plus 2/2, fully green Clippy Matrix run `31471819294`, and Main CI macOS feature-matrix job `93716959602`; TODO-640 closure evidence is H3 9/9, persona headers 13/13, and complete stealth 268/268; TODO-641 closure evidence is focused domain-fronting 9/9, complete stealth 269/269, stealth config 9/9, and stealth mode 7/7 in the same hosted revision. TODO-643 closes qftls page-exclusive `munlock` ownership with native macOS/Linux execution. TODO-644 closes the bounded qf-stealth probe detector and TODO-808 closes the separate bounded EscalationState history; macOS job `93669407470` passes their named regressions inside qf-stealth 127/127 and the root library 1,619/1,619. Reality session map timer-driven cleanup is resolved by TODO-570.
