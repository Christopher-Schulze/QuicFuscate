...
- Exact ARM64 source `24c4a92` failed the new stability gate against unchanged binary `c54d2d5e1c600790fcc0c2d437fdb5f3942e8337dadd2138896f0bf958ac6a2e`: child status was failed/passed/failed. The complete middle child measured 7.433 to 10.635 Mbit/s, 43.09% gain, 2-second black-hole detection, and 15,335,424 receiver bytes in 20.688 seconds. The other two reached default medians of 7.437 and 8.362 Mbit/s, then opt-in persistent congestion at 0.07% and 0.06% observed loss before receiver evidence; child 3 additionally reached fail-closed heartbeat timeouts on clients 2 and 3. All children used the same binary and cleanly removed owned runtime resources. TODO-559 remains blocked by the reproducible live transport failure.
