...
- Dirty-tree seam evidence: `scripts/out/audits/workspace-seams-20260810T-implementation-engine-contracts-dirty/workspace-seams.json` at base revision `ac16901f1ffa85b032a46c932f5b8fcdbdafbe91`; `36` packages, `334` Rust files, `207,167` source lines, `109` module edges, `116` workspace dependency edges, SCCs `engine/implementations` and `qftls/transport`, and `protected_changes=[]`.
