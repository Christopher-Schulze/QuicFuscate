...
- Exact counter-recovery tests cover guard drop/transfer, basic and dictionary compression/decompression failures, and TUN read failures. FEC and zero-copy DATAGRAM buffer ownership remain TODO-832 and TODO-833.
