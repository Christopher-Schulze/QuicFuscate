...
- **FEC recovery**: unbounded fountain-decoder storage (TODO-634), adaptive emitted-ID cap (TODO-635), decoder peeling complexity (TODO-636), and Wiedemann buffer reuse (TODO-637, complete). TODO-637 closure evidence is focused Wiedemann 2/2, FEC 242/242, telemetry 1/1, high-loss `k=128/256` Criterion coverage, fully green Clippy Matrix run `31471819294`, and Main CI macOS feature-matrix job `93716959602`.
