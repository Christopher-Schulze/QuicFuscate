---
id: TODO-969
title: Decoder8/16 single-pass solve + SmallVec rejection evidence
status: DONE
created: 2026-09-18
---
...
|---|---|---|
| baseline | ~116 us | - |
| + `SmallVec<[u8;256]>` coeffs | ~130 us | +7% regression flag |
| + revert to `Vec<u8>` | ~133 us | no change (p=0.47) |
