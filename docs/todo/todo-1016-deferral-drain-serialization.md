...
loop - is fixed in TODO-1021 (done, Omega-verified). The 80%-of-baseline acceptance is still open after the 2026-09-21
Omega re-run that actually armed the window (see TODO-1015):
