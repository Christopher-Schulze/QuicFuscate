...
impl CongestionController for Bbr3 {
    ...
    fn update_rtt(&mut self, rtt: Duration) {
        ...
        Bbr3::update_rtt_at(self, rtt, self.probe_rtt_min_stamp);
    }

    fn update_rtt_at(&mut self, rtt: Duration, now: Instant) {
        Bbr3::update_rtt_at(self, rtt, now);
    }
    ...
    fn on_persistent_congestion(&mut self, min_cwnd: usize) {
        // Restart the bandwidth model from scratch (RFC 9002 sec. 7.6 allows a full
