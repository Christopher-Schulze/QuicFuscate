...
pub struct FingerprintProfile {
    ...
    /// QUIC initial_max_stream_data_uni transport parameter (bytes).
    pub initial_max_stream_data_uni: u64,
    /// QUIC initial_max_streams_bidi transport parameter.
    pub initial_max_streams_bidi: u64,
    /// QUIC initial_max_streams_uni transport parameter.
...
impl FingerprintProfile {
    ...
    pub fn new_with_snapshot(
        ...
        // Flow-control transport parameters come from the checked-in capture
        // fixture for this engine family (TODO-1047): the same parsed values
        // drive both the Initial transport-parameter block and the runtime
        // transport configuration, so they cannot drift apart.
        crate::transport_params::apply_to_fingerprint(&mut profile);
