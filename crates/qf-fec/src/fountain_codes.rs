...
impl LTEncoder {
    ...
    #[doc(hidden)]
    pub fn set_seed(&mut self, rng_seed: u64) {
...
impl LTDecoder {
    ...
    /// Return the pool used for materializing recovered FEC packets.
    #[doc(hidden)]
    ...
    pub fn new_with_repair_limit(
        ...
        let max_symbols = requested_max_symbols.clamp(1, MAX_FOUNTAIN_SOURCE_SYMBOLS);
...
mod tests {
    ...
    fn make_pool() -> Arc<MemoryPool> {
        Arc::new(MemoryPool::new_adaptive(512, 65_536))
    }
