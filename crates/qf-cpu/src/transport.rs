...
//!
//! The module is intentionally independent of the monolithic transport runtime. It consumes the
//! stable `qf-transport-types` statistics contract and exposes pure packet-number/bitmap/ECN
//! helpers to the root compatibility layer.

#[cfg(target_arch = "aarch64")]
use crate::telemetry::CONGESTION_NEON_BATCHES;
#[cfg(target_arch = "x86_64")]
use crate::telemetry::{CONGESTION_AVX2_BATCHES, CONGESTION_VNNI_BATCHES};
