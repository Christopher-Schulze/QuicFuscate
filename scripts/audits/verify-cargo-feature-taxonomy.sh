...
FEATURE_CONTRACT: dict[str, tuple[str, tuple[str, ...]]] = {
    ...
    "client": ("product", ()),
    "server": ("product", ("rcgen", "time", "maxminddb", "qf-pki/rcgen")),
    "io_uring": ("runtime", ("dep:io-uring",)),
    "aggressive_inline": (
        "runtime",
        (
            "qf-cpu/aggressive_inline",
            "qf-crypto/aggressive_inline",
            "qf-simd/aggressive_inline",
            "qf-transport-udp/aggressive_inline",
        ),
    ),
    ...
    "internal_avx10_preview": (
        "internal",
        (
            "qf-cpu/internal_avx10_preview",
            "qf-crypto/internal_avx10_preview",
            "qf-simd/internal_avx10_preview",
        ),
    ),
    "rust-tests": (
        "test",
        (
            "qf-compress/rust-tests",
            "qf-cpu/rust-tests",
            "qf-crypto/rust-tests",
            "qf-dns/rust-tests",
            "qf-fec/rust-tests",
            "qf-harness/rust-tests",
            "qf-logging/rust-tests",
            "qf-memory-lock/rust-tests",
            "qf-memory-pool/rust-tests",
            "qf-metrics/rust-tests",
            "qf-reality/rust-tests",
            "qf-stealth/rust-tests",
            "qf-simd/rust-tests",
            "qf-transport-anti-replay/rust-tests",
            "qf-transport-batch/rust-tests",
            "qf-transport-cc/rust-tests",
            "qf-transport-nat/rust-tests",
            "qf-transport-pn/rust-tests",
            "qf-transport-path/rust-tests",
            "qf-transport-recovery/rust-tests",
            "qf-transport-version/rust-tests",
            "qf-transport-types/rust-tests",
            "qf-transport-udp/rust-tests",
        ),
    ),
    "benches": ("test", ("qf-crypto/benches", "qf-simd/benches")),
    "masque-tests": ("test", ()),
    "tun-tests": ("test", ()),
    "simd-selfcheck": ("test", ()),
