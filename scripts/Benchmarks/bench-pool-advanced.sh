#!/usr/bin/env bash
# Description: Pool benchmark with advanced profiling (JSON/time)
...
CMD="cargo run --features benches --quiet -- pool-bench --iterations 500000 --payload 1200 --pool-capacity 2048 --block-size 4096 --json"
